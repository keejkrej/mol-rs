...
pub fn element_by_number(atomic_number: u8) -> &'static ElementData {
    ELEMENTS.get(atomic_number as usize).unwrap_or(&ELEMENTS[0])
}
...
/// PyMOL-style metal classification by atomic number.
pub fn is_metal_atomic_number(atomic_number: u8) -> bool {
    matches!(
        atomic_number,
        3..=4 | 11..=13 | 19..=31 | 37..=50 | 55..=84 | 87..=u8::MAX
    )
}
